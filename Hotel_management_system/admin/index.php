...
if(isset($login))
{
	...
	{
	$sql=mysqli_query($con,"select * from admin_hotel where username='$eid' && password='$pass' ");
  ...
  <div class="container">
    <div class="row"><br>
      <div class="col-sm-4"></div>
		<div class="col-sm-4 text-center"style="box-shadow:2px 2px 2px;background-color:">
