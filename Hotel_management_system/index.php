...
<div id="myCarousel" class="carousel slide" data-ride="carousel"> <!--Slider Image Start Here--> 
    ...
    <div class="carousel-inner" role="listbox">
      <?php
		$i=1;
	  $sql=mysqli_query($con,"select * from slider_hotel");
	  ...
	  <div class="item active">
        <img src="<?php echo $path; ?>" alt="Image" height="50%" width="50%">
...
<div class="container text-center">    
  <h1><font color="#a6e22b;"><b>Welcome To Online Hotel.Com</b></font></h1><hr><br>
  <div class="row">
